                              ...
                              /*This Code SIMPLY CREATES our DATABASES and the TABLES WITHIN*/

								#DATABASE 1 - 'invoicing' 
...
CREATE TABLE `payment_methods` (                       #Create Table called 'payment_methods' 
  `payment_method_id` INTEGER(4) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `clients` (                           #Create Table called 'clients'
...
CREATE TABLE `invoices` (                        #Create Table called 'invoices'
...
CREATE TABLE `payments` (                                 #Create Table called 'Payments'
...
INSERT INTO `payments` VALUES (8,5,18,'2019-01-08',10.00,2);
                                            ...
                                            #DATABASE 2 - 'sql_store' 
DROP DATABASE IF EXISTS sql_store;                   
CREATE DATABASE sql_store;
USE sql_store;

CREATE TABLE products (                                   #Create Table called 'products'
...
CREATE TABLE `shippers` (                                   #Create Table called 'shippers'
...
CREATE TABLE `customers` (                                  #Create Table called 'customers'
...
CREATE TABLE `order_statuses` (                           #Create Table of 'order_statuses'
...
CREATE TABLE `orders` (                                    #Create Table of 'orders'      
...
CREATE TABLE `order_items` (                              #Create Table of 'order_items'
  `order_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sql_store`.`order_item_notes` (                    #Table of 'order_item_notes'
...
CREATE TABLE `offices` (                                       #Table of 'offices'
...
CREATE TABLE `employees` (                              #Table of 'employees'
